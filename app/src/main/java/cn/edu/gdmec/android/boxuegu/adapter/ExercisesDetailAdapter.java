...
public class ExercisesDetailAdapter extends BaseAdapter{
   ...
   private ArrayList<String> selectedPosition =new ArrayList<String>();
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
      ...
      if (view==null){
          vh=new ViewHolder();
          view= LayoutInflater.from(mContext).inflate(R.layout.exercises_detail_list_item,null);
          vh.subject=view.findViewById(R.id.tv_subject);
          vh.tv_a=view.findViewById(R.id.tv_a);
          vh.tv_b=view.findViewById(R.id.tv_b);
          vh.tv_c=view.findViewById(R.id.tv_c);
          vh.tv_d=view.findViewById(R.id.tv_d);
          vh.iv_a=view.findViewById(R.id.iv_a);
          vh.iv_b=view.findViewById(R.id.iv_b);
          vh.iv_c=view.findViewById(R.id.iv_c);
          vh.iv_d=view.findViewById(R.id.iv_d);
          view.setTag(vh);
      }else {
